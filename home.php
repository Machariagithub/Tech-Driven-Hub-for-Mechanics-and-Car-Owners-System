...
<head>
    ...
    <link rel="stylesheet" href="home24.css">
</head>
<body>

<!-- Header-->
<header class="header-bg py-5" id="main-header">
    <div class="container header-container">
        <div class="header-content">
            <h1 class="header-title"><?php echo $_settings->info('name') ?></h1>
            <p class="header-text">We will take care of your vehicle</p>
            <div class="header-btn">
                <button class="btn btn-primary btn-lg" id="send_request" type="button">Send Service Request</button>
            </div>
        </div>
    </div>
</header>
...
<section class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h3 class="section-title">We Do Service For:</h3>
                <hr class="section-hr">
                <ul class="service-list">
                    ...
                    ?>
                    <li class="service-item"><b><?php echo $row['category'] ?></b></li>
                    <?php endwhile; ?>
                </ul>
            </div>
            <div class="col-md-8">
                ...
                <div class="row service-row" id="service_list">
                    <?php 
